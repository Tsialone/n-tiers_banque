...
public class EpargneApiController {
        ...
        @GET
        @Path("/byClient")
        public Response getTransactionByIdClient(
                        @QueryParam("idClient") int idClient
                        ) {
                try {
                        HttpResponse<String> response = Unirest.get(BASE_URL + "/TransactionEpargne/byClient")
        ...
        public Response getEpargnesByClient(
                ...
                try {
                        System.out.println("tayyyyyyyyyyyyyyyyyyyyyy " + date);
                        HttpResponse<String> response = Unirest.get(BASE_URL + "/CompteEpargne/byClientSolde")
                                        .queryString("idClient", idClient)
                                        .queryString("date", date != null && !date.isEmpty() ? date : null)
                                        .asString();
