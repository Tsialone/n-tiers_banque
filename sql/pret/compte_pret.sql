...
-- Compte prêt
INSERT INTO comptes_pret (id_client, date_ouverture, montant, taux_interet, duree_mois, date_echeance)
VALUES (1, '2025-09-01', 1000.00, 10.00, 4, '2026-01-01');

-- Amortissements (simplifié, avec capital et intérêts arrondis)
INSERT INTO amortissements (id_compte, mois, mensualite, interet, capital, reste_du)
VALUES 
(1, 1, 260.00, 8.33, 251.67, 748.33),
(1, 2, 260.00, 6.23, 253.77, 494.56),
(1, 3, 260.00, 4.12, 255.88, 238.68),
(1, 4, 260.00, 1.99, 258.01, 0.00);
